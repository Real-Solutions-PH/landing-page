...
const ROADMAP_PHASES: RoadmapPhase[] = [
  {
    ...
    description:
      "Map your tools, workflows, gaps, and software opportunities before heavy engineering begins.",
    categories: [
      {
        ...
        items: [
          {
            ...
            description:
              "Workflow audit, pain-point mapping, systems map, solution brief, MVP recommendation, detailed estimate.",
          },
        ],
      },
    ],
  },
  {
    ...
    description:
      "Interactive clickable prototypes and technical feasibility validations. See it before we build it.",
    categories: [
      {
        title: "Prototyping",
        items: [
          {
            ...
            description:
              "Interactive clickable prototype, user flow validation, technical feasibility review, refined requirements.",
          },
        ],
      },
    ],
  },
  {
    ...
    description:
      "Production-grade development across operational tools, integrations, AI features, and mobile platforms.",
    categories: [
      {
        ...
        items: [
          {
            ...
            description:
              "1–2 system integrations (e.g., POS + accounting), basic dashboard, deployment, testing.",
          },
          {
            ...
            description:
              "3–5 system integrations, workflow automation, role-based dashboards, admin panel, API webhooks.",
          },
          {
            ...
            description:
              "6+ integrations, complex workflows, real-time sync, analytics dashboards, multi-user management.",
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            description:
              "Single-purpose internal tool (booking system, tracker, CRM), basic auth, admin panel.",
          },
          {
            ...
            description:
              "Multi-module system, user auth, role management, core workflows, reporting, admin panel, deployment.",
          },
          {
            ...
            description:
              "Complex business logic, multi-tenant support, advanced integrations, analytics, scalable architecture.",
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            description:
              "Marketing site, CMS, contact forms, basic SEO, mobile-responsive.",
          },
          {
            ...
            description:
              "Custom design, animations, advanced features, blog/CMS, lead generation tools.",
          },
          {
            ...
            description:
              "User portals, dashboards, auth system, backend integration, admin management.",
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            description:
              "Single-purpose AI feature (FAQ bot, document Q&A, knowledge assistant) embedded in existing system.",
          },
          {
            ...
            description:
              "Multi-step AI workflow (document processing, AI-assisted decisions, workflow copilot), integrated into operations.",
          },
          {
            ...
            description:
              "Full AI-native system (RAG system, multi-agent workflow, custom LLM integration, analytics).",
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            description:
              "Single-platform (iOS or Android), basic features, auth, 3–5 screens.",
          },
          {
            ...
            description:
              "React Native/Flutter app, auth, core features, backend integration, deployment.",
          },
          {
            ...
            description:
              "Complex features, offline support, push notifications, analytics, admin backend.",
          },
        ],
      },
    ],
  },
  {
    ...
    description:
      "Ongoing support and iterative feature growth to ensure long-term stability after MVP completion.",
    categories: [
      {
        ...
        items: [
          {
            ...
            description:
              "Bug fixes, monitoring, security patches, backups, monthly health check, async support.",
          },
          {
            name: "Growth Plan",
            time: "Ongoing",
            ...
            description:
              "Everything in Care + monthly feature work (8–16 hours), optimization, advisory, roadmap planning.",
          },
          {
            ...
            description:
              "Priority support, weekly planning, continuous feature development (40+ hours/month), strategic advisory.",
          },
          {
            ...
            description:
              "Prompt optimization, chatbot updates, knowledge base refresh, usage analytics, model performance monitoring.",
          },
        ],
      },
    ],
...
const ADD_ONS: PricingCategory = {
  ...
  description:
    "Specialized enhancements, setup, and specific feature expansions.",
  items: [
    {
      ...
      description:
        "API docs, system architecture, deployment guides, user manuals.",
    },
    {
      name: "Staff Training",
      time: "1 week",
      ...
      description:
        "Live training sessions (2–4 hours), video tutorials, Q&A support.",
    },
    {
      ...
      description:
        "Help desk integration, ticketing system, support workflows.",
    },
    {
      ...
      description:
        "Custom business intelligence dashboard, KPI tracking, reporting.",
    },
    {
      ...
      description:
        "Internationalization (i18n), translation integration, locale management.",
    },
    {
      ...
      phPromoPrice: "₱14,000 – ₱38,500",
      description:
        "Convert web app to mobile app (iOS/Android) using WebView or similar.",
    },
  ],
};
...
const PricingCard = ({
  ...
  >
    <div className="flex justify-between items-start mb-3 gap-4">
      <h4 className="text-md font-bold leading-tight text-foreground">
        {item.name}
      </h4>
      {item.time && (
        <Badge
          variant="secondary"
          className="font-normal text-[10px] whitespace-nowrap bg-muted/50 text-muted-foreground border-transparent"
        >
          {item.time}
        </Badge>
      )}
      ...
      <div className="text-foreground">
        {location === "LOADING" ? (
          ...
          <div className="flex flex-col">
            <span className="text-xs text-muted-foreground line-through opacity-70 mb-0.5 tracking-tight">
              {item.phOriginalPrice}
            </span>
...
export function PricingSection() {
  const [location, setLocation] = useState<"PH" | "INTL" | "LOADING">(
    "LOADING",
  );
        ...
        <div className="flex flex-col items-center justify-center text-center mb-24">
          ...
          >
            ...
            <h2 className="mb-6 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
              Custom software &amp; integration pricing — Philippines &amp;
              International
            </h2>
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
              We do not hide our pricing. Philippine SMEs and international
              clients need to know the numbers to make decisions. Our engagement
              model guides you from discovery to scaled operations.
            </p>
          </motion.div>
        </div>
