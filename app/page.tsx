...
export const metadata: Metadata = {
  title: "Real Solutions PH | Custom Software & System Integration Company in the Philippines",
  description:
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Real Solutions PH — Custom Software & System Integration for Philippine SMEs" }],
  },
};
